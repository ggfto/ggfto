...
Since I was a child I've been fascinated with technology and always wondered what could I do with it. At the age of 13 I won my first computer as a gift from my father and then my journey started. With 14 years I learned how to install multiple operational systems, with emphasis in windows. With 18 years, I started working with Access Control equipment and also Factory Automation. One year later, I started to develop in Delphi/Pascal, building only custom reports for the clients of the company I was working for. Some time in 2010 I also started to build softwares related to Access Control, and 9 years I've spent like this. Meanwhile, I also developed some skills with SQL, CSS, HTML, Firewalls, Linux, VPNs, etc.

In 2019 I decided to take an opportunity in another company as a Full time Delphi developer (I also actuated like support an had some administrative tasks in the other company), this consequently brought me to the JAVA world, language that I use everyday at my current job.

At the beginning of June of 2020 I started a hobby project with a friend, tha consists of building a GTAV RP server just for fun, that's when Lua came to my life.
